        ...
        <div className={`${styles.wrapper} ${isMobile ? styles.mobile : ''}`}>
          ...
          <nav className={`${styles.sidebar} ${sidebarActive ? styles.active : styles.collapsed}`}
            ...
            <ul className={styles.sidebarMenu} style={{ background: colors.DarkVibrant }}>
              ...
              <li className={styles.tooltipContainer} data-tooltip="Bandcamp Playlist">
                <Link
                  href="/bandcamplaylist"
                  className={styles.navbarItem}
                  style={{
                    color: sidebarTextColor,
                    background: pathname.startsWith("/bandcamplaylist")
                      ? colors.LightMuted
                      : 'transparent'
                  }}
                >
                  ...
                  <span className={!sidebarActive ? styles.hidden : ''}>Bandcamp Playlist</span>
                </Link>
              </li>
