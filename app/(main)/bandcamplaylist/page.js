...
export default function BandcampPlaylistBase() {
  ...
  return (
    <div className={styles.container}>
      ...
      >
        ...
        <p className={styles.subtitle}>View Bandcamp IDs</p>
      </div>
      ...
      >
        <div className={styles.emptyState}>
          <p>Use the URL format: <code>/bandcamplaylist/domain.bandcamp.com/path/...</code></p>
          <p style={{ marginTop: '1rem', opacity: 0.7 }}>Example: <code>/bandcamplaylist/ariabare.bandcamp.com/album/bunny-fluffer/balaclavarecords.bandcamp.com/album/ep01</code></p>
        </div>
      </div>
    </div>
  );
